 ...
 * @author Kangbok Lee
 */
public class FXMLDeleteKeyDialogController implements Initializable {
    ...
    @FXML
    private void delete(ActionEvent evt) throws IOException{
        boolean deleted = model.deleteKey(key.getText());
        ...
        if(deleted){
            ...
            try {
                ...
                controller.setText("ERROR: The keyword does not exist");
                dialog.show();
            } catch(Exception ex) {
